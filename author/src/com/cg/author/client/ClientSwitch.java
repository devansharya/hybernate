	...
	public static void main(String[] args) {
		...
		do {
			...
			case 1:
				...
				author.setFirstName("Devansh");
				author.setMiddleName("H");
				author.setLastName("arya");
				author.setPhoneNo(8943);
		 ...
		 * service.findAuthorById(100);
		 * System.out.print("ID:"+author.getAuthorId());
		 * System.out.println(" FirstName:"+author.getFirstName());
		 * 
		 * author.setFirstName("Prashant"); service.updateAuthor(author);
		 * 
